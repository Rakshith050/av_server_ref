                    ...
                    <div class="row">
                        <div class="col-lg-12 pt-0 mb-3 d-flex justify-content-between">
                            ...
                            <div class="float-right">
                                <a href="/sub_admin/add_student" class="p-2  d-inline-block text-white fw-700 lh-30 rounded-lg  text-center font-xsssss ls-3 bg-current">Add
                                    student</a>
                            </div>
                        </div>
                            ...
                            <table id="myTable" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/student_profile/{{ $student->id }}" class="btn bg-current text-center text-white font-xsss fw-600 p-2  rounded-lg d-inline-block border-0">View
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
